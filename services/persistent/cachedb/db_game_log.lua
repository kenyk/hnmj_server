...
db_mysql.room_result = {
	sql = [[ insert room_result_log (room_id, end_time, game_num, owner, chair_1_uid, chair_1_name, chair_1_point, chair_1_image, chair_2_uid, chair_2_name, chair_2_point, chair_2_image, chair_3_uid, chair_3_name, chair_3_point, chair_3_image, chair_4_uid, chair_4_name, chair_4_point, chair_4_image)
			 values('$room_id', '$end_time', $game_num, $owner,$chair_1_uid, '$chair_1_name', $chair_1_point, '$chair_1_image', $chair_2_uid, '$chair_2_name', $chair_2_point, '$chair_2_image', $chair_3_uid, '$chair_3_name', $chair_3_point, '$chair_3_image', $chair_4_uid, '$chair_4_name', $chair_4_point, '$chair_4_image')
			]]
}
